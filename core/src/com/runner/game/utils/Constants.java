...
public class Constants {
    ...
    public static final String CHARACTER_ATLAS_PATH = "characters.txt";
    ...
    public static final String RUNNER_JUMP_REGION_NAME = "alienGreen_jump";
    ...
    public static final Vector2 RUNNER_JUMPING_LINEAR_IMPULSE = new Vector2(0, 13);
